"""Validates trade aggregate records using Great Expectations before writing to storage."""
...
def validate_aggregation_records(
    ...
    try:
        ...
        logger.info(f"Aggregation validation: {len(valid_records)} valid, {len(invalid_records)} invalid (quarantined)")
