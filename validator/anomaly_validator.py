"""Validates anomaly/alert records using Great Expectations before writing to storage."""
...
def validate_alert_records(
    ...
    try:
        ...
        logger.info(f"Alert validation: {len(valid_records)} valid, {len(invalid_records)} invalid (quarantined)")
