"""
Technical Indicators Job Module for PySpark Streaming Processor.

Contains TechnicalIndicatorsJob for calculating technical indicators
(SMA, EMA, RSI, MACD, Bollinger Bands, ATR) from cryptocurrency market data.

This module provides:
- CandleState: State container for maintaining candle history per symbol
- IndicatorCalculator: Calculator for technical indicators
- TechnicalIndicatorsJob: Spark Structured Streaming job for calculating indicators

Requirements Coverage:
---------------------
    - Requirement 1.1: TechnicalIndicatorsJob in its own file
    - Requirement 2.2: IndicatorCalculator specific to this job
    - Requirement 2.3: CandleState specific to this job
"""
...
from src.utils.metrics import record_error, record_message_processed, track_latency
