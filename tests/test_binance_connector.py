...
class TestWebSocketClient:
    ...
    def test_backoff_configured_correctly(self):
        ...
        client = BinanceWebSocketClient(url="wss://test.example.com/stream", streams=["btcusdt@trade"])
...
class TestMessageProcessor:
    ...
    def test_process_trade_message(self):
        ...
        raw_json = json.dumps(
            {"stream": "btcusdt@trade", "data": {"e": "trade", "s": "BTCUSDT", "p": "50000.00", "q": "0.001"}}
        )
    ...
    def test_process_kline_message_returns_none(self):
        ...
        raw_json = json.dumps(
            {"stream": "btcusdt@kline_1m", "data": {"e": "kline", "s": "BTCUSDT", "k": {"o": "50000", "c": "50100"}}}
        )
    ...
    def test_process_ticker_message(self):
        ...
        raw_json = json.dumps(
            {"stream": "btcusdt@ticker", "data": {"e": "24hrTicker", "s": "BTCUSDT", "c": "50000.00"}}
        )
    ...
    def test_process_unknown_event_returns_none(self):
        ...
        raw_json = json.dumps({"stream": "btcusdt@unknown", "data": {"e": "unknownEvent", "s": "BTCUSDT"}})
